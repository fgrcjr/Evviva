      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16 animate-on-scroll">
          ...
          <p className="text-lg text-sage-600 max-w-2xl mx-auto">
            We'd love to hear from you. Get in touch with us for any questions about our programs.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="space-y-8 animate-on-scroll">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-sage-800 mb-2">Visit Us</h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-sage-800 mb-2">Call Us</h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-sage-800 mb-2">Email Us</h2>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm border border-sage-100 animate-on-scroll">
            <h2 className="text-2xl font-bold text-sage-800 mb-6">Schedule a Tour</h2>
