...
const programs = [
  {
    ...
    description:
      "Focus on creating a safe and nurturing environment with individualized attention.",
    activities: [
  ...
  },
  {
    ...
    description:
      "Designed for children who need care before or after school hours.",
    activities: [
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16 animate-on-scroll">
          ...
          <p className="text-lg text-sage-600 max-w-2xl mx-auto">
            At Evviva, we offer age-appropriate programs designed to nurture
            your child&apos;s development at every stage.
          </p>
        </div>
